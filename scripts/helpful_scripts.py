...
def fund_with_link(contract_address,account=None,link_token=None,amount=100000000000000000):
  ...
  #link_token_contract = interface.LinkTokenInterface(contract_address, amount, {"from": account})
  #tx = link_token.contract.transfer(contract_address, amount, {"from": account})
  tx.wait(1)
  print("Fund contract!")
  return tx
